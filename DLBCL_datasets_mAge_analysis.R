...
## expression matrix
expression_data <- read.table("./datasets/Ruijin/DLBCL_759_RNAseq_rawcounts.txt",header=T)
rownames(expression_data) <- expression_data$gene
expression_data <- expression_data[,-1]

## match the expression matrix and patient data
group_data <- read.table("./datasets/Ruijin/DLBCL.RJ759.patients.txt",header=T,fill = TRUE,sep = "\t")
...
## expression matrix
expression_data = read.table("./datasets/Schmitz_2018NEJM/RNAseq_gene_expression_562.txt",header=T,sep = "\t")
rownames(expression_data) <- expression_data$Gene
expression_data <- expression_data[,c(-1,-2,-3)]

## patient metadata
group_data <- read.table("RNAseq_gene_expression_562.patients.txt",header=T,fill = TRUE,sep = "\t")
...
## expression matrix
expression_data = read.table("./datasets/Sha_2018JCO/GSE117556_series_matrix.txt",header=T,sep = "\t")
rownames(expression_data) <- expression_data$ID_REF
expression_data <- expression_data[,-1]

## match the expression matrix and patient data
group_data <- read.table("./datasets/Sha_2018JCO/GSE117556_series_matrix.patients.txt",header=T,fill = TRUE,sep = "\t")
...
## match the expression matrix and patient data
group_data <- read.table("./datasets/Chapuy_2018NatMed/GSE98588_series_matrix.sample.info.txt",header=T,fill = TRUE,sep = "\t")
...
## match the expression matrix and patient data
group_data <- read.table("./datasets/Lacy_2020Blood/GSE181063_series_matrix.patients.txt",header=T,fill = TRUE,sep = "\t")
